from typing import Any, Optional, Union, Generic, TypeVar, List, overload, Type, Tuple
...
class Query(object, Generic[T]):
    session: Any = ...
    def __init__(self, entities: List[Type], session: Optional[Any] = ...) -> None: ...
    @property
    def statement(self): ...
    ...
    def with_entities(self, *entities: Any) -> 'Query[Union[Any, Tuple[Any, ...]]]': ...
    ...
    def update(self, values: Any, synchronize_session: Union[bool, str] = ..., update_args: Optional[Any] = ...) -> int: ...
